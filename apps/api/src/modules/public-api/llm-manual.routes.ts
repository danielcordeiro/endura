...
- [Tools para function calling](${baseUrl}/api/v1/public/openapi/tools.json): tools no formato Anthropic, prontas para colar em \`system.tools\`. Cobre summary, atividades, planned workouts, wellness, PMC, readiness, busca de catalogo, log de nutricao (single + bulk), follow-protocol, feedback, daily check-in e comentarios, **alem da memoria do coach (context/assessments/directives/profile), previsao de prova, projecao de forma (PMC forward-looking ate o dia da prova), calendario de provas (A/B/C) e escrita autoritativa de planos/treinos com suplementacao**.
