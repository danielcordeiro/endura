...
3. **Strain Target diário (S–M)** — readiness passa a sugerir uma **faixa de TSS-alvo** para hoje (não só o nível). Fecha o loop com a projeção (quanto treinar p/ chegar no pico).
